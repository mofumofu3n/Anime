...
import com.ichif1205.anime.request.PopularArticleRequest;
...
public class TodayArticleFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        final PopularArticleRequest request = new PopularArticleRequest();
        request.find();
        loading();
    }
    ...
    @Subscribe
    public void onResponse(PopularArticleRequest.SuccessEvent event) {
    ...
    @Subscribe
    public void onError(PopularArticleRequest.ErrorEvent event) {
